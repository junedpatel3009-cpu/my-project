    ...
    <div className={fullWidth ? "min-h-screen" : "min-h-screen lg:grid lg:grid-cols-2"}>
      <div className="flex min-h-screen flex-col px-6 py-8 lg:px-12">
        <div className="flex items-center justify-between gap-4">
          ...
          {viewer ? (
            <div className="flex items-center gap-2">
              <Button asChild variant="outline" size="sm" className="h-11 rounded-2xl bg-background px-5 shadow-sm">
        ...
        >
          ...
          {footer && (
            <div className={`mt-6 text-sm text-muted-foreground ${fullWidth ? "text-left" : "text-center"}`}>
              {footer}
            </div>
          )}
        </div>
      ...
      {!fullWidth ? <div className="relative hidden gradient-hero lg:block">
